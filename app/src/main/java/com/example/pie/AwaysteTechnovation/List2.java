...
public class List2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lstCompost=findViewById(R.id.lstCompost);
        lstRecycle=findViewById(R.id.lstRecycle);

        donateArrayList = new ArrayList<String>();
        // function A ( function B(), function C(), "ABC")

        // AddItemToList ( getList(), getPosition(), getText());
        //
        // B = function B();
        // C = function C();
        // Function A( B, C, "ABC")
        // ApplicationContext myAppContext = this.getApplicationContext();
...
//        spinner.setAdapter(adapter1);
    ...
    public static Intent makeIntent(Context context) {
        return new Intent(context, List2.class);
};}
